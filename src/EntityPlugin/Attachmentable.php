...
class Attachmentable extends Plugin{
	...
	/** @var \Atomino\Molecules\EntityPlugin\Attachmentable\Attributes\AttachmentCollection[] */
	...
	/** @var \Atomino\Molecules\Module\Attachment\AttachmentCollectionInterface[] */
